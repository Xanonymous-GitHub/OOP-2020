...
TEST(Term_test, operator_assignment)
{
...
TEST(Term_test, operator_multiply)
{
    double coefficient1 = 3114.44f, coefficient2 = 3114.0f;
    int exponent1 = 9, exponent2 = 3;
    Term term1(coefficient1, exponent1), term2(coefficient2, exponent2);
    Term term = (term1 * term2);
    ASSERT_NEAR(9698365.977539, term.getCoefficient(), 0.001);
    ASSERT_EQ(12, term.getExponent());
}
TEST(Term_test, operator_equal)
{
...
TEST(Term_test, access_coefficient_of_a_term)
{
...
TEST(Term_test, access_exponent_of_a_term)
{
    double coefficient1 = 64.44f;
    int exponent1 = 3;
    Term term1(coefficient1, exponent1);
...
TEST(Term_test, evaluate_by_a_given_x)
{
    double coefficient1 = 64.44f;
    int exponent1 = 3;
    double x = 19.1;
